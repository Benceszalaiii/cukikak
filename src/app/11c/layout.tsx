  ...
  if (session.Class?.name !== "11.C") {
    return (
      <>
        <Nav />
        <main className="min-h-screen px-4 lg:px-32 w-full flex flex-col justify-center items-center gap-4">
          <h2 className="text-5xl text-red-700 motion-preset-focus font-semibold font-geistmono">
            Eltévedtél?
          </h2>
          <p className="tracking-widest text-neutral-400 my-6 text-sm">
            Ha tudod hogy jó helyen jársz, írj rám.
          </p>
          <Link href={"/"} draggable={false}>
            <ShinyButton submitted={false} type="button" className="">
              Főoldal
            </ShinyButton>
          </Link>
        </main>
